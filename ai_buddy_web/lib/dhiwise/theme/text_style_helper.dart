...
class TextStyleHelper {
  ...
  // DhiWise compatibility aliases
  TextStyle get headline37BoldInter => TextStyle(
        fontSize: 37.fSize,
        fontWeight: FontWeight.bold,
        fontFamily: 'Inter',
      );
  ...
  TextStyle get titleMediumInter => TextStyle(
        fontSize: 16.fSize,
        fontFamily: 'Inter',
      );
  ...
  // Additional commonly used styles (DhiWise generated)
  TextStyle get titleSmallInter => TextStyle(
        fontSize: 16.fSize,
        fontFamily: 'Inter',
      );

  TextStyle get bodySmallInter => TextStyle(
        fontSize: 12.fSize,
        fontFamily: 'Inter',
      );
