...
class CustomButton extends StatelessWidget {
  ...
  /// Alias: DhiWise sometimes provides onTap instead of onPressed
  ...
  /// DhiWise style placeholder (not used extensively but accepted for compatibility)
  ...
  Widget build(BuildContext context) {
    ...
    switch (effectiveButtonType) {
      ...
      case CustomButtonType.outline:
        // Map outline to a TextButton with border
        return _buildTextButton(
          effectiveTextColor,
          effectiveBorderColor,
          true, // show border
...
enum CustomButtonType { elevated, text, icon, outline }

/// DhiWise style placeholders to avoid missing symbol errors
class CustomButtonStyles {
  static const String outlinePrimary = 'outlinePrimary';
}
